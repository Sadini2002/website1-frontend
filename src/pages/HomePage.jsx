...
export default function HomePage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat"
      ...
      <div className="relative z-10 bg-white/10 backdrop-blur-xl p-10 rounded-3xl shadow-2xl text-center border border-white/20">
        <h1 className="text-4xl text-white font-bold mb-4">Welcome to Our Store</h1>
